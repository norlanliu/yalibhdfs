 ...
 * =====================================================================================
 *
 *       Filename:  config_internal.cc
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  05/20/2015 08:22:00 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
ConfigurationInternal::ConfigurationInternal(const Configuration & conf) {
    ...
    ConfigDefault<int32_t> i32Values[] = {
        {
            &rpcMaxIdleTime, "rpc.client.max.idle", 10 * 1000, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            ...
            &rpcMaxRetryOnConnect, "rpc.client.connect.retry", 10, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            &rpcTimeout, "rpc.client.timeout", 3600 * 1000
        }, {
            &defaultReplica, "dfs.default.replica", 3, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            ...
            &localReadBufferSize, "input.localread.default.buffersize", 1 * 1024 * 1024, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            &prefetchSize, "dfs.prefetchsize", 10, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            &maxGetBlockInfoRetry, "input.read.getblockinfo.retry", 3, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            &maxLocalBlockInfoCacheSize, "input.localread.blockinfo.cachesize", 1000, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            &maxReadBlockRetry, "input.read.max.retry", 60, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            &chunkSize, "output.default.chunksize", 512, std::bind(CheckMultipleOf<int32_t>, _1, _2, 512)
        }, {
            &packetSize, "output.default.packetsize", 64 * 1024
        }, {
            &blockWriteRetry, "output.default.write.retry", 10, std::bind(CheckRangeGE<int32_t>, _1, _2, 1)
        }, {
            ...
            &rpcMaxHARetry, "dfs.client.failover.max.attempts", 15, std::bind(CheckRangeGE<int32_t>, _1, _2, 0)
        }, {
            &maxFileDescriptorCacheSize, "dfs.client.read.shortcircuit.streams.cache.size", 256, std::bind(CheckRangeGE<int32_t>, _1, _2, 0)
        }, {
            &socketCacheExpiry, "dfs.client.socketcache.expiryMsec", 3000, std::bind(CheckRangeGE<int32_t>, _1, _2, 0)
        }, {
            &socketCacheCapacity, "dfs.client.socketcache.capacity", 16, std::bind(CheckRangeGE<int32_t>, _1, _2, 0)
        }
    };
    ConfigDefault<int64_t> i64Values [] = {
        {
            &defaultBlockSize, "dfs.default.blocksize", 64 * 1024 * 1024, std::bind(CheckMultipleOf<int64_t>, _1, _2, 512)
        }
    };
